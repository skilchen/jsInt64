...
Kotlin.Long.prototype.toString = function(opt_radix) {
  ...
  var rem = this;
  console.log("radixToPower: " + radixToPower)
  console.log("rem: " + rem.low_ + " " + rem.high_)
  var result = '';
  while (true) {
    var remDiv = rem.div(radixToPower);
    console.log("remDiv: " + remDiv.low_ + " " + remDiv.high_)
...
Kotlin.Long.prototype.multiply = function(other) {
  ...
  console.log("x.high: " + this.high_ + " x.low: " + this.low_)
  var a48 = this.high_ >>> 16;
  var a32 = this.high_ & 0xFFFF;
  var a16 = this.low_ >>> 16;
  var a00 = this.low_ & 0xFFFF;
  ...
  c48 &= 0xFFFF;
  console.log("c16: " + c16 + " c00: " + c00 + " c48: " + c48 + " c32: " + c32);
  console.log((c16 << 16))
  return Kotlin.Long.fromBits((c16 << 16) | c00, (c48 << 16) | c32);
};
...
Kotlin.Long.prototype.div = function(other) {
  ...
  while (rem.greaterThanOrEqual(other)) {
    ...
    console.log("approxRes repr: " + approxRes.low_ + " " + approxRes.high_)
    console.log("approxRes: " + approxRes + " " + other)
    var approxRem = approxRes.multiply(other);
    console.log("approxRem: " + approxRem.low_ + " " + approxRem.high_)
